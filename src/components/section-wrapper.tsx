export const SectionWrapper = ({ children, header, title, id }) => {
  return (
    <section id={id} className="min-h-screen flex flex-col gap-10 mb-10">
      ...
      <div className="max-w-[800px] flex flex-col w-full mx-auto gap-10">
        {children}
      </div>
    </section>
  );
