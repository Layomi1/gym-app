...
export const ExerciseCard = ({ exercise, i }) => {
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex sm:flex-row sm:flex-wrap  sm:items-center flex-col gap-x-4">
      ...
      <div className="grid grid-cols-2  sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-600 w-full items-start"
        >
          <h3 className="capitalize text-slate-400 text-sm"> Set completed</h3>
